...
L'architecture MVC et un designe pattern conçu pour faciliter ,qui permet de séparer le code en plusieurs 3 parties distincts,
pour bien organiser le code et facilite 
